								...
								<div class="wrapper">
									...
									<form id="login-form"
										...
										<c:choose>
											...
											<c:otherwise>
												<input type="text" class="form-control" name="Username"
													id="Username" placeholder="帳號" value="${param.Username}"
													autofocus />

												<div class="form-group text-center" style="color: #FF0000;">
													${ErrorMsgKey.AccountEmptyError}</div>
										...
										<c:choose>
											<c:when
												test="${cookie['SESSION_LOGIN_USERNAME'].value != null}">
											...
											<c:otherwise>
												...
												<div class="form-group text-center">
													<input type="checkbox" tabindex="3" class=""
														name="remember" id="remember" value="true"> <label
				...
				<div class="modal-content">
					...
					<div class="modal-body" style="font-weight: 700;">
						<form id="update-memberpassword-form" method="post" role="form"
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="email" id="checkEmail"
										class="form-control" name="checkEmail" 
										placeholder="example@abc.com.tw">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-6">請輸入電話號碼</label>
								<div class="col-sm-6">
									<input type="text" id="checkPhoneNumber"
										class="form-control" name="checkPhoneNumber"
										placeholder="0900100200">
								</div>
							</div>

...
<link
	href="${pageContext.request.contextPath}/WebShop/css/star-rating-svg.css"
	rel="stylesheet">
...
<jsp:useBean id="gps" class="_05_Stock.StockBean" scope="page" />
<title>產品追蹤清單</title>
...
<body>
					...
					<c:forEach var="tk" items="${TrackingList_coll}">
						<div class="col-md-3 col-sm-6 hero-feature">
							<div id="${tk.productId}" class="thumbnail">
								...
								<div class="caption">
									<span class="name">${tk.name}</span> : NT<span class="price">${tk.pgPrice}</span><br>
	...
	<script
		src="${pageContext.request.contextPath}/WebShop/js/jquery-3.1.1.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/WebShop/js/bootstrap.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/WebShop/js/jquery.star-rating-svg.js"></script>
	<script
		src="${pageContext.request.contextPath}/WebShop/js/TrackList.js"></script>
</body>

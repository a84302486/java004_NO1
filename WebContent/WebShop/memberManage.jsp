          ...
          <div class="account-row">
              <form class="form-horizontal" style="font-weight:900;">
					<div class="form-group">
						<div class="col-md-offset-2 col-md-1 info">會員帳號</div>
						<div class="col-md-4">${MemberLoginOK.m_Username}</div>
						<div class="col-md-offset-1 col-md-3 info">
					...
					<div class="form-group">
						<div class="col-md-offset-2 col-md-1 info">會員密碼</div>
						<div class="col-md-4"><a href="/account/modify_password" class="link-color">修改會員密碼</a></div>
					</div>
					<div class="form-group">
						<div class="col-md-offset-2 col-md-1 info">會員姓名</div>
						<div class="col-md-4">${MemberLoginOK.m_Name}</div>
					</div>
					<div class="form-group">
						<div class="col-md-offset-2 col-md-1 info">會員地址</div>
						<div class="col-md-4">${MemberLoginOK.m_Address}</div>
					</div>
					<div class="form-group">
						<div class="col-md-offset-2 col-md-1 info">會員手機</div>
						<div class="col-md-4">${MemberLoginOK.m_Cellphone}</div>
					</div> 
					<div class="form-group">
						<div class="col-md-offset-2 col-md-1 info">會員生日</div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title text-center" id="myModalLabel" style="font-weight:900;">編輯帳戶資料</h4>
        </div>
        <div class="modal-body" style="font-weight:700;">
				<form id="update-member-form" method="post" role="form"
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="email" id="member_Username" name="Username" class="form-control" value="${MemberLoginOK.m_Username}" readonly>							
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" id="Name" placeholder="請輸入真實姓名"
								class="form-control required" name="Name" autofocus value="${MemberLoginOK.m_Name}"/>
						</div>
					</div>
					<div class="form-group" id="dvAddress">
						...
						<div class="col-sm-8">
							<input type="hidden" class="cCountry" value="TW" /> <input
								...
								class="form-control required cAddress" autofocus value="${MemberLoginOK.m_Address}"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" id="Cellphone" name="Cellphone"
								...
								class="form-control required cellphonecheck" autofocus value="${MemberLoginOK.m_Cellphone}"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" name="Birthday" id="birthday"
								class="form-control required date dayCheck" autofocus value="${MemberLoginOK.m_Birthday}"/>
					...
					<div class="modal-footer">
          				...
          				<button type="button" class="btn btn-primary" id="update-member">儲存修改</button>
        			</div>
